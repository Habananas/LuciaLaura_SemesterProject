...
# Dendogram: (takes a (+hour)-long to compute)
#install.packages("factoextra")
library(factoextra)
# Visualize the hierarchical clustering dendrogram
fviz_dend(hc_ward, k = 5, rect = TRUE, rect_fill = TRUE,
