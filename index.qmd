...
- wir wollen wissen, ob alle punkte, die im GIS cluster den wert 5 haben, im k-cluster den entsprechenden Wert zB 3 haben. Dabei muss es nicht unbedingt  o
Papers to read: 
...
The SSE is lowest for 5 clusters (4.433731e+05), which indicates good clustering, however, the ssi (silhouette width) is lowest, indicating bad clustering. Therefore, 4 clusters is taken. 
